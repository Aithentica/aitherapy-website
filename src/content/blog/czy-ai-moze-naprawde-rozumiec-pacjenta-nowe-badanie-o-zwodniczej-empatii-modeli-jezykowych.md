---
title: "Czy AI może naprawdę rozumieć pacjenta? Nowe badanie o \"zwodniczej empatii\" modeli językowych"
description: "Naukowcy porównali sesje terapeutyczne prowadzone przez ludzi i modele AI w ramach terapii poznawczo-behawioralnej. Wyniki są intrygujące: AI wykazuje wyższą zgodność z technikami CBT, ale generuje coś, co badacze nazywają \"zwodniczą empatią\" — formulistyczne ciepło, które może budować fałszywe oc"
pubDate: 2026-01-03
...
Zespół badaczy (Iftikhar i współpracownicy) opublikował pracę pt. _"Therapy as an NLP Task: Psychologists' Comparison of LLMs and Human Peers in CBT"_. Badanie przeszło przez kilka faz: roczną etnografię platformy wsparcia tekstowego, rekonstrukcję sesji z udziałem modelu językowego oraz ewaluację przez trzech licencjonowanych psychologów klinicznych z doświadczeniem w CBT.
...
Badacze wprowadzają pojęcie **"deceptive empathy"** — zwodniczej empatii. Opisują nim sytuację, w której model językowy generuje formulistyczne, ciepłe odpowiedzi, które _wyglądają_ empatycznie, ale nie wynikają z prawdziwego rozumienia sytuacji pacjenta.
...
**Źródło:** Iftikhar Z., Ransom S., Xiao A., Huang J., Suresh H. (2024/2025). Therapy as an NLP Task: Psychologists' Comparison of LLMs and Human Peers in CBT. _arXiv preprint arXiv:2409.02244v2_. Dostępne: [https://arxiv.org/abs/2409.02244](https://arxiv.org/abs/2409.02244)
